...
/** High-level WebSocket message abstraction.
  ...
  *
  * A single message may span multiple frames when fragmented, but the WebSocket implementation
  * handles reassembly transparently. Messages only represent the two data types: Text and Binary.
  */
