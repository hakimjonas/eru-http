...
object H2Frame {
  ...
  // ============================================================================
  // Frame Type Codes (RFC 9113 Section 4)
  // ============================================================================

  /** Frame type codes as defined in RFC 9113. */
  object FrameType {
    val Data: Byte = 0x00
    val Headers: Byte = 0x01
    val Priority: Byte = 0x02 // Deprecated in RFC 9113
  ...
  // ============================================================================
  // Frame Flags (RFC 9113 Section 4.1)
  // ============================================================================
  ...
  object SettingsParam {
    ...
    def name(id: Int): String = id match {
      case HeaderTableSize => "SETTINGS_HEADER_TABLE_SIZE"
      case EnablePush => "SETTINGS_ENABLE_PUSH"
      case MaxConcurrentStreams => "SETTINGS_MAX_CONCURRENT_STREAMS"
      case InitialWindowSize => "SETTINGS_INITIAL_WINDOW_SIZE"
      case MaxFrameSize => "SETTINGS_MAX_FRAME_SIZE"
      case MaxHeaderListSize => "SETTINGS_MAX_HEADER_LIST_SIZE"
      case other => s"UNKNOWN(0x${other.toHexString})"
    }
  }

  /** Default settings values per RFC 9113. */
  object DefaultSettings {
    val HeaderTableSize: Int = 4096
    val EnablePush: Boolean = true
    val MaxConcurrentStreams: Int = Int.MaxValue // Unlimited
    val InitialWindowSize: Int = 65535
    val MaxFrameSize: Int = 16384
    val MaxHeaderListSize: Int = Int.MaxValue // Unlimited
  }
}
